...
//                log.debug("Response :\r\n{}", body);
            ...
            if (cookies != null && cookies.size() > 0) {
                ...
                if (!"webpush.controller.wechat.com".equals(okHttpRequest.url().host())) {
                ...
                if (!"file.controller.wechat.com".equals(okHttpRequest.url().host())) {
                    cookieStore.put("file.web.wechat.com", cookies);
                }
                if (!"controller.wechat.com".equals(okHttpRequest.url().host())) {
